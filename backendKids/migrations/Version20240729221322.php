 ...
 */
final class Version20240729221322 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE category (id INT AUTO_INCREMENT NOT NULL, coach_id INT DEFAULT NULL, chapter_id INT DEFAULT NULL, lesson_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, INDEX IDX_64C19C13C105691 (coach_id), INDEX IDX_64C19C1579F4768 (chapter_id), INDEX IDX_64C19C1CDF80196 (lesson_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
