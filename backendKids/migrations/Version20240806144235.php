 ...
 */
final class Version20240806144235 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE lesson (id INT AUTO_INCREMENT NOT NULL, chapter_id INT DEFAULT NULL, coach_id INT NOT NULL, title VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, lesson_number INT NOT NULL, INDEX IDX_F87474F3579F4768 (chapter_id), INDEX IDX_F87474F33C105691 (coach_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
