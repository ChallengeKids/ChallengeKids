 ...
 */
class getKidResponseRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\KidResponseRepository' shared autowired service.
     *
     * @return \App\Repository\KidResponseRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'KidResponseRepository.php';

        return $container->privates['App\\Repository\\KidResponseRepository'] = new \App\Repository\KidResponseRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
