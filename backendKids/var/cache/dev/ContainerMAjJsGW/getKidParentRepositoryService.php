 ...
 */
class getKidParentRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\KidParentRepository' shared autowired service.
     *
     * @return \App\Repository\KidParentRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'KidParentRepository.php';

        return $container->privates['App\\Repository\\KidParentRepository'] = new \App\Repository\KidParentRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
