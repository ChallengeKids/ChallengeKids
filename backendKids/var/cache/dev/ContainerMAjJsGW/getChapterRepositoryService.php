 ...
 */
class getChapterRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ChapterRepository' shared autowired service.
     *
     * @return \App\Repository\ChapterRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ChapterRepository.php';

        return $container->privates['App\\Repository\\ChapterRepository'] = new \App\Repository\ChapterRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
