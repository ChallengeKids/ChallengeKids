 ...
 */
class getKidRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\KidRepository' shared autowired service.
     *
     * @return \App\Repository\KidRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'KidRepository.php';

        return $container->privates['App\\Repository\\KidRepository'] = new \App\Repository\KidRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
