...
export const environment = {
  backednUrl: 'https://127.0.0.1:8000',
  production: false,
  appVersion: 'v8.2.4',
  ...
  appHTMLIntegration:
    'https://preview.keenthemes.com/metronic8/demo2/documentation/base/helpers/flex-layouts.html',
  appPreviewUrl: 'https://preview.keenthemes.com/metronic8/angular/demo2/',
  appPreviewAngularUrl:
    'https://preview.keenthemes.com/metronic8/angular/demo2',
